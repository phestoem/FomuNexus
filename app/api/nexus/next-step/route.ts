...
async function extractDataFromUserInput(params: {
  ...
  const { object } = await generateObject({
    ...
    prompt: [
      ...
      "- Agent relevance filtering may only apply to fields that are not listed in `targetSchema.required`; required fields must always receive a concrete user-provided value.",
